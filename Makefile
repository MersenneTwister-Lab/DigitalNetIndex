...
pkgdatadir = $(datadir)/digitalnetindex
pkgincludedir = $(includedir)/digitalnetindex
pkglibdir = $(libdir)/digitalnetindex
pkglibexecdir = $(libexecdir)/digitalnetindex
...
ACLOCAL = ${SHELL} /Users/saito/git/mkt/DigitalNetIndex/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /Users/saito/git/mkt/DigitalNetIndex/missing autoconf
AUTOHEADER = ${SHELL} /Users/saito/git/mkt/DigitalNetIndex/missing autoheader
AUTOMAKE = ${SHELL} /Users/saito/git/mkt/DigitalNetIndex/missing automake-1.15
AWK = awk
CC = gcc
...
LIBS = -lsqlite3 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/saito/git/mkt/DigitalNetIndex/missing makeinfo
...
PACKAGE_STRING = digitalnetindex 0.4
...
abs_top_srcdir = /Users/saito/git/mkt/DigitalNetIndex
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /Users/saito/git/mkt/DigitalNetIndex/install-sh
...
top_srcdir = .
SUBDIRS = src sqlite3
dist_pkgdata_DATA = example/* data/*
