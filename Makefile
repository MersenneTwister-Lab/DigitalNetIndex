...
ACLOCAL = ${SHELL} /Users/saito/git/mkt/DigitalNetIndex/missing aclocal-1.16
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} /Users/saito/git/mkt/DigitalNetIndex/missing automake-1.16
AWK = awk
CC = gcc
...
PACKAGE_STRING = digitalnetindex 0.7
